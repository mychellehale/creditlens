...
Missing a default costs more than a false alarm. A bank that flags too many good customers loses business; a bank that misses defaults loses money. CreditLens treats these as unequal errors and optimizes accordingly. Recall on the default class is the north-star metric.
